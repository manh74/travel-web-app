                        ...
                        <div class="col-lg-12">
                            @foreach ($contacts as $contact)
                                <form  action="{{route('update-contacts', $contact->id)}}" method="post">
                                    @csrf
                                    <input class="form-control" name="address" value="{!! $contact['address'] !!}">
                                    <input class="form-control" name="phone" value="{!! $contact['phone_number'] !!}">
                                    <input class="form-control" name="email" value="{!! $contact['email'] !!}">
                                    <input class="form-control" name="working_date" value="{!! $contact['working_date'] !!}">
